-- ProShare Migration: Create prefixed tables in main database
-- Generated: 2026-04-06
-- Description: Moves ProShare tables from separate DB to main DB with proshare_ prefix
-- Tables migrated to main database with prefix: proshare_
-- Run against your main database
-- Original: proshare separate DB
