...
CREATE TABLE IF NOT EXISTS `navbar_settings` (
    ...
    `logo_text_gradient_enabled` TINYINT(1) NOT NULL DEFAULT 0,
    `logo_text_gradient_start` VARCHAR(20) NOT NULL DEFAULT '#00f0ff',
    `logo_text_gradient_end` VARCHAR(20) NOT NULL DEFAULT '#ff2ec4',
