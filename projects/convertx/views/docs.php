...
<div class="card" style="max-width:860px;">
    ...
    <p style="font-size:.875rem;color:var(--text-muted);margin-bottom:1.5rem;">
        Integrate ConvertX into any application using our REST API.
...
Authorization: Bearer cx_your_api_key_here</pre>
    ...
    <p style="font-size:.85rem;color:var(--text-muted);margin-bottom:.5rem;">Submit a file for conversion. Returns a Job ID for polling.</p>
