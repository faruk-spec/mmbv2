    ...
    <style>
        ...
        * {
        ...
        @keyframes lightBgFlow {
            0% {
                background:
                    radial-gradient(ellipse at 10% 10%, rgba(37, 211, 102, 0.14) 0%, transparent 50%),
                    radial-gradient(ellipse at 90% 90%, rgba(7, 94, 84, 0.12) 0%, transparent 50%),
                    radial-gradient(ellipse at 60% 50%, rgba(18, 140, 126, 0.06) 0%, transparent 40%);
            }
            33% {
                background:
                    radial-gradient(ellipse at 85% 15%, rgba(37, 211, 102, 0.12) 0%, transparent 50%),
                    radial-gradient(ellipse at 15% 85%, rgba(7, 94, 84, 0.14) 0%, transparent 50%),
                    radial-gradient(ellipse at 40% 20%, rgba(18, 140, 126, 0.07) 0%, transparent 40%);
            }
            66% {
                background:
                    radial-gradient(ellipse at 50% 90%, rgba(7, 94, 84, 0.10) 0%, transparent 50%),
                    radial-gradient(ellipse at 60% 10%, rgba(37, 211, 102, 0.14) 0%, transparent 50%),
                    radial-gradient(ellipse at 20% 50%, rgba(18, 140, 126, 0.06) 0%, transparent 40%);
            }
            100% {
                background:
                    radial-gradient(ellipse at 10% 10%, rgba(37, 211, 102, 0.14) 0%, transparent 50%),
