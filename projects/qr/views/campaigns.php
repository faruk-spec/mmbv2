...
<div class="glass-card">
    <div class="empty-state" style="padding: 60px 20px;">
        ...
        <h2 style="font-size: 24px; margin-bottom: 15px; color: var(--text-primary);">Campaign Management</h2>
        <p style="color: var(--text-secondary); margin-bottom: 30px;">Organize your QR codes into campaigns for better tracking and management.</p>
        ...
        <div class="feature-list" style="text-align: left; max-width: 500px; margin: 0 auto;">
            <div class="feature-item">
                ...
                <span>Group QR codes by campaign</span>
            </div>
            <div class="feature-item">
                <i class="fas fa-check-circle" style="color: var(--cyan);"></i>
            ...
            <div class="feature-item">
                <i class="fas fa-check-circle" style="color: var(--cyan);"></i>
                <span>Analyze scan data by campaign</span>
            </div>
            <div class="feature-item">
                <i class="fas fa-check-circle" style="color: var(--cyan);"></i>
                <span>Export campaign reports</span>
            </div>
        </div>
