...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;flex-wrap:wrap;gap:12px;">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;">
        ...
        <a href="/projects/billx/download/<?= (int)$bill['id'] ?>" class="btn btn-secondary btn-sm">
...
#billDocWrapper.crambled { background: #cdc8bf !important; }
#billDocWrapper.crambled #billDocument {
    position: relative;
    filter: sepia(14%) brightness(0.96) contrast(0.97);
    transform: rotate(-0.25deg);
}
#billDocWrapper.crambled #billDocument::after {
    content: '';
    position: absolute;
    inset: 0;
    pointer-events: none;
