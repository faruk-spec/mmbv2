        ...
        <?php if (!empty($enabledProviders)): ?>
            <?php foreach ($enabledProviders as $provider): ?>
                ...
                <div style="margin-bottom: 8px;">
                    <a href="/auth/<?= View::e($name) ?>" class="btn" style="width: 100%; background: #fff; color: #333; border: 1px solid #ddd; font-size: 0.95rem; padding: 12px 20px;">
