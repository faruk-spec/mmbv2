...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin-bottom: 30px;">
    <div class="stat-card" style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.1) 0%, rgba(139, 92, 246, 0.1) 100%); padding: 20px; border-radius: 12px; border: 1px solid var(--border-color);">
    ...
    <div class="stat-card" style="background: linear-gradient(135deg, rgba(34, 197, 94, 0.1) 0%, rgba(59, 130, 246, 0.1) 100%); padding: 20px; border-radius: 12px; border: 1px solid var(--border-color);">
    ...
    <div class="stat-card" style="background: linear-gradient(135deg, rgba(245, 158, 11, 0.1) 0%, rgba(139, 92, 246, 0.1) 100%); padding: 20px; border-radius: 12px; border: 1px solid var(--border-color);">
                        ...
                        <tr style="border-bottom: 1px solid var(--border-color);">
                            ...
                            <td style="padding: 15px; text-align: center;">
                                <?php if ($user['two_factor_enabled']): ?>
                                    <span style="display: inline-flex; align-items: center; gap: 6px; padding: 4px 12px; background: rgba(34, 197, 94, 0.1); color: var(--green); border-radius: 20px; font-size: 0.85rem; font-weight: 600;">
                                ...
                                <?php else: ?>
                                    <span style="display: inline-flex; align-items: center; gap: 6px; padding: 4px 12px; background: rgba(239, 68, 68, 0.1); color: var(--red); border-radius: 20px; font-size: 0.85rem; font-weight: 600;">
                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                ...
                                <div style="display: flex; gap: 8px; justify-content: flex-end;">
                                    <?php if ($user['two_factor_enabled']): ?>
                                        ...
                                        <form method="POST" action="/admin/2fa/<?= $user['id'] ?>/toggle" style="display: inline;" onsubmit="return confirm('Disable 2FA for this user?');">
                                            <?= \Core\Security::csrfField() ?>
                                            <button type="submit" class="btn btn-sm btn-danger" style="padding: 6px 12px; background: rgba(239, 68, 68, 0.1); color: var(--red); border: 1px solid var(--red); border-radius: 6px; font-size: 0.85rem; cursor: pointer;">
                                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="display: inline-block; vertical-align: middle; margin-right: 4px;">
                                                    <circle cx="12" cy="12" r="10"></circle>
                                                    <line x1="15" y1="9" x2="9" y2="15"></line>
                                                    <line x1="9" y1="9" x2="15" y2="15"></line>
