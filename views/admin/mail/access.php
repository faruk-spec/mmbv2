        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span class="badge-success" style="font-size:12px;padding:3px 8px;border-radius:4px;background:rgba(16,185,129,.15);color:#6ee7b7;"><i class="fas fa-check"></i> Super Admin (always)</span>
                ...
                <td>
                    <div style="display:flex;gap:6px;flex-wrap:wrap;">
                        ...
                        <?php if ($u['has_mail_perm'] && $u['role'] !== 'super_admin'): ?>
...
<div class="card" style="margin-top:20px;background:rgba(102,126,234,.06);border-color:rgba(102,126,234,.2);">
    ...
    <ul style="font-size:13px;color:#94a3b8;margin:0;padding-left:20px;line-height:1.8;">
        <li><strong>Super Admin</strong> users always have access to <code>/mail</code>.</li>
        <li><strong>Admin</strong> and regular users need the <strong>mail</strong> permission granted here.</li>
