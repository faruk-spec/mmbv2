...
.plan-toggle-feedback.ok  { background:rgba(34,197,94,.15); border:1px solid var(--green); color:var(--green); }
.plan-toggle-feedback.err { background:rgba(239,68,68,.15); border:1px solid var(--red); color:var(--red); }
</style>
<?php View::endSection(); ?>
        ...
        <div class="plan-body">
            ...
            <div class="grid grid-2" style="gap:0;">
                ...
                $planFeatureLabels = [
                    ...
                    // Advanced / paid
                    'bulk_generation'     => ['icon'=>'fas fa-layer-group',   'label'=>'Bulk Generation'],
                    'ai_design'           => ['icon'=>'fas fa-robot',         'label'=>'AI Design'],
                    'api_access'          => ['icon'=>'fas fa-plug',          'label'=>'API Access'],
