...
<div class="container-fluid">
    ...
    <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:16px;margin-bottom:28px;">
        ...
        $statItems = [
            ...
            ['label' => 'Total Clicks',  'value' => number_format($stats['total_clicks']),  'color' => '#00ff88', 'icon' => 'mouse-pointer'],
            ['label' => 'Active Links',  'value' => $stats['active_links'],  'color' => '#ffd700', 'icon' => 'check-circle'],
            ['label' => 'Total Users',   'value' => $stats['total_users'],   'color' => '#ff2ec4', 'icon' => 'users'],
            ['label' => 'Links Today',   'value' => $stats['links_today'],   'color' => '#ffaa00', 'icon' => 'calendar-day'],
        ];
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:24px;">
        <div style="background:var(--bg-card);border:1px solid var(--border-color);border-radius:12px;padding:20px;">
            <h3 style="font-size:1rem;font-weight:600;margin-bottom:16px;display:flex;align-items:center;gap:8px;"><i class="fas fa-trophy" style="color:#ffaa00;"></i> Top Links</h3>
            <div style="overflow-x:auto;">
                <table style="width:100%;border-collapse:collapse;font-size:14px;">
                    ...
                    <tr style="border-bottom:1px solid rgba(255,255,255,0.04);">
                        ...
                        <td style="padding:10px 12px;color:#ffaa00;font-weight:600;"><?= number_format($link['total_clicks']) ?></td>
                    </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
