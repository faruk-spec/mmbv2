        ...
        <tr>
            <td style="padding:40px 20px;">
                <table role="presentation" style="max-width:600px;margin:0 auto;background:linear-gradient(135deg,#0c0c12 0%,#0f0f18 100%);border-radius:16px;overflow:hidden;border:1px solid rgba(255,255,255,0.1);">
                    <!-- Header -->
                    <tr>
                        <td style="padding:36px 40px 20px;text-align:center;background:linear-gradient(135deg,rgba(0,255,136,0.08),rgba(0,240,255,0.08));">
                            <div style="display:inline-flex;align-items:center;justify-content:center;width:56px;height:56px;border-radius:50%;background:linear-gradient(135deg,#00ff88,#00f0ff);margin-bottom:14px;">
                                <span style="font-size:22px;">✅</span>
                            </div>
                            <h1 style="margin:0;color:#00ff88;font-size:22px;font-weight:700;">
                    ...
                    <tr>
                        <td style="padding:36px 40px;">
                            ...
                            <table role="presentation" style="width:100%;border-collapse:collapse;margin-bottom:20px;">
                                <tr>
                                    <td style="padding:16px;background:rgba(0,255,136,0.05);border:1px solid rgba(0,255,136,0.15);border-radius:8px;">
                                        <div style="margin-bottom:10px;">
                                            <div style="color:#8892a6;font-size:12px;text-transform:uppercase;letter-spacing:.05em;margin-bottom:3px;">Ticket</div>
                                            <div style="color:#00ff88;font-size:16px;font-weight:700;">#<?= (int)$ticketId ?></div>
                                        </div>
                                        <div>
                            ...
                            <table role="presentation" style="width:100%;border-collapse:collapse;margin-bottom:26px;">
                                <tr>
                                    <td style="padding:16px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-left:3px solid #00ff88;border-radius:0 8px 8px 0;color:#c4cad8;font-size:14px;line-height:1.7;">
                            ...
                            <table role="presentation" style="width:100%;border-collapse:collapse;">
                                <tr>
                                    <td style="text-align:center;">
                                        <a href="<?= htmlspecialchars($ticketUrl ?? '#') ?>" style="display:inline-block;padding:14px 32px;background:linear-gradient(135deg,#00ff88,#00f0ff);border-radius:8px;color:#06060a;font-size:15px;font-weight:700;text-decoration:none;">
                                            View Closed Ticket
                                        </a>
                                    </td>
                                </tr>
