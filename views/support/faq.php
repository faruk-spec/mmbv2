    ...
    <div class="sp-main">
            ...
            <div style="margin-bottom:22px;">
                <h1 style="font-size:1.4rem;font-weight:700;color:var(--text-primary);margin:0 0 4px;display:flex;align-items:center;gap:10px;">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" style="color:var(--cyan)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
                    Frequently Asked Questions
                </h1>
                <p style="color:var(--text-secondary);margin:0;font-size:.85rem;">Find answers to the most common questions.</p>
            </div>
            ...
            <div style="display:flex;flex-direction:column;gap:10px;">
                ...
                $faqs = [
                    ...
                    ['q'=>'How do I escalate an urgent issue?','a'=>'Create a new ticket with <strong style="color:var(--red);">Urgent</strong> priority, or use Live Chat for immediate attention.'],
                ...
                ?>
                <div class="faq-item" style="background:var(--bg-card);border:1px solid var(--border-color);border-radius:10px;overflow:hidden;">
                    <button onclick="toggleFaq(<?= $i ?>)" style="width:100%;padding:14px 18px;background:none;border:none;cursor:pointer;display:flex;align-items:center;justify-content:space-between;gap:12px;text-align:left;">
                        <span style="font-weight:600;font-size:.9rem;color:var(--text-primary);"><?= htmlspecialchars($faq['q']) ?></span>
                        <svg id="faq-icon-<?= $i ?>" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--text-secondary)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0;transition:transform .2s;"><polyline points="6 9 12 15 18 9"/></svg>
                    </button>
                    <div id="faq-body-<?= $i ?>" style="display:none;padding:0 18px 14px;border-top:1px solid var(--border-color,rgba(255,255,255,.05));">
                        <p style="margin:12px 0 0;color:var(--text-secondary);font-size:.88rem;line-height:1.7;"><?= $faq['a'] ?></p>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
            ...
            <div style="margin-top:24px;background:linear-gradient(135deg,rgba(59,130,246,.06),rgba(139,92,246,.04));border:1px solid rgba(59,130,246,.15);border-radius:12px;padding:20px;text-align:center;">
                ...
                <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap;">
                    ...
                    <a href="/support/live" style="display:inline-flex;align-items:center;gap:7px;padding:9px 18px;background:color-mix(in srgb,var(--cyan) 10%,transparent);border:1px solid color-mix(in srgb,var(--cyan) 20%,transparent);border-radius:7px;color:var(--cyan);font-weight:600;text-decoration:none;font-size:.875rem;">
