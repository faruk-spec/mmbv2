        ...
        <div style="flex:1;min-width:0;">
            <div style="margin-bottom:22px;">
                <h1 style="font-size:1.4rem;font-weight:700;color:var(--text-primary,#e8eefc);margin:0 0 4px;display:flex;align-items:center;gap:10px;">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff2ec4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 3H2l8 9.46V19l4 2v-8.54L22 3z"/></svg>
                    Announcements
                </h1>
                <p style="color:var(--text-secondary,#8892a6);margin:0;font-size:.85rem;">Platform updates, maintenance notices, and outage reports.</p>
            </div>
            ...
            <div style="display:flex;flex-direction:column;gap:12px;">
                ...
                <div style="background:var(--bg-card,#0f0f18);border:1px solid <?= $ann['color'] ?>33;border-left:3px solid <?= $ann['color'] ?>;border-radius:10px;padding:18px 20px;">
                    <div style="display:flex;align-items:flex-start;gap:12px;">
                        ...
                        <div style="flex:1;">
                            <div style="display:flex;align-items:center;gap:10px;margin-bottom:6px;flex-wrap:wrap;">
                                <span style="font-weight:700;color:var(--text-primary,#e8eefc);font-size:.92rem;"><?= htmlspecialchars($ann['title']) ?></span>
                            ...
                            <p style="color:var(--text-secondary,#8892a6);font-size:.87rem;margin:0;line-height:1.6;"><?= htmlspecialchars($ann['body']) ?></p>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
