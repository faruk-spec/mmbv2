...
<div style="margin-bottom: 40px;">
    <h1 style="font-size: 2rem; margin-bottom: 8px; background: linear-gradient(135deg, var(--cyan), var(--magenta)); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">Profile Settings</h1>
    <p style="color: var(--text-secondary); font-size: 1rem;">Manage your personal information and preferences</p>
</div>
...
<div class="grid grid-3" style="gap: 24px;">
    ...
    <div>
        <div class="card" style="text-align: center; border-radius: 16px; overflow: hidden; border: 1px solid var(--border-color); padding: 30px;">
            ...
            <h3 style="font-size: 1.3rem; margin-bottom: 6px;"><?= View::e($user['name']) ?></h3>
            ...
            <div style="margin-top: 24px; padding-top: 24px; border-top: 1px solid var(--border-color);">
                ...
                <div style="font-size: 1rem; font-weight: 600; color: var(--text-primary);"><?= Helpers::formatDate($user['created_at']) ?></div>
            </div>
        </div>
        
        <div class="card" style="margin-top: 20px; border-radius: 16px; overflow: hidden; border: 1px solid var(--border-color); padding: 24px;">
