...
<div style="margin-bottom: 40px;">
    <h1 style="font-size: 2rem; margin-bottom: 8px; background: linear-gradient(135deg, var(--cyan), var(--magenta)); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">Security Settings</h1>
    <p style="color: var(--text-secondary); font-size: 1rem;">Protect your account with strong security measures</p>
</div>
        ...
        <div style="text-align: center; padding: 40px 30px;">
            <?php if ($twoFactorEnabled): ?>
                <div style="width: 80px; height: 80px; background: rgba(0, 255, 136, 0.1); border-radius: 50%; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 30px rgba(0, 255, 136, 0.2);">
                    <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="var(--green)" stroke-width="2">
                        <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
                        <path d="M9 12l2 2 4-4"/>
                    </svg>
                </div>
                <h4 style="color: var(--green); margin-bottom: 12px; font-size: 1.2rem;">2FA Enabled</h4>
                <p style="color: var(--text-secondary); margin-bottom: 24px; line-height: 1.6;">Your account is protected with two-factor authentication. An additional code is required for login.</p>
            ...
            <?php else: ?>
                <div style="width: 80px; height: 80px; background: rgba(255, 170, 0, 0.1); border-radius: 50%; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 30px rgba(255, 170, 0, 0.2);">
                    <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="var(--orange)" stroke-width="2">
                        <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
                        <line x1="12" y1="9" x2="12" y2="13"></line>
                        <line x1="12" y1="17" x2="12.01" y2="17"></line>
                    </svg>
                </div>
                <h4 style="color: var(--orange); margin-bottom: 12px; font-size: 1.2rem;">2FA Disabled</h4>
                <p style="color: var(--text-secondary); margin-bottom: 24px; line-height: 1.6;">Add an extra layer of security to your account by enabling two-factor authentication.</p>
...
<div class="card mt-3" style="border-radius: 16px; overflow: hidden; border: 1px solid var(--border-color); margin-top: 24px;">
