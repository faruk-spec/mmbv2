    ...
    <div style="padding: 12px;">
        <?php if (empty($activity)): ?>
            <div style="text-align: center; padding: 60px 20px;">
                ...
                <p style="color: var(--text-secondary); font-size: 0.875rem;">Your account activities will appear here</p>
            </div>
        <?php else: ?>
            <div style="overflow-x: auto;">
                <table class="table" style="width: 100%; min-width: 600px; border-collapse: separate; border-spacing: 0;">
                    <thead>
                        <tr style="background: var(--bg-secondary);">
                            <th style="padding: 12px; text-align: left; border-bottom: 1px solid var(--border-color); font-weight: 600; color: var(--text-primary); font-size: 0.85rem;">
